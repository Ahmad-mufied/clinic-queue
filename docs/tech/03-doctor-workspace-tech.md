...
| **v1.3.0** | 2026-08-30 | Frontend Architect | **Unified Workspace Consolidation** | Aligned frontend navigation to single `/doctor` workspace route containing both consultation controls and live waiting queue stream. |
